...
class HtmlElementTypeError extends Error {
  constructor(received, matcherFn, context) {
    ...
    this.message = [(0, _jestMatcherUtils.matcherHint)(`${context.isNot ? '.not' : ''}.${matcherFn.name}`, 'received', ''), '', `${(0, _jestMatcherUtils.RECEIVED_COLOR)('received')} value must be an HTMLElement or an SVGElement.`, (0, _jestMatcherUtils.printWithType)('Received', received, _jestMatcherUtils.printReceived)].join('\n');
  }

}

function checkHtmlElement(htmlElement) {
  if (!htmlElement.ownerDocument && !(htmlElement instanceof htmlElement.ownerDocument.HTMLElement) && !(htmlElement instanceof htmlElement.ownerDocument.SVGElement)) {
